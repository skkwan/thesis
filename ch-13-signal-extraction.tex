In this chapter we outline the statistics terminology and concepts underlying the modified frequentist method $CL_{S}$ used to perform signal extraction.
