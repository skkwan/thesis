...
% \begin{itemize}
%     \item 
%     \item The $SU(2)$ term, $\mathcal{D}_\mu = \partial_\mu - ig W^\alpha_\mu(x) \cdot \tau_\alpha/2$ is constructed with a triplet of four-potentials: $W_\mu(x) = (W_\mu^1(x), W_\mu^2(x), W_\mu^3(x))$ where the $\tau/2$ matrices are generators of the $SU(2)$ transformation.
%     \item The gluon field is $G_\mu$
%     \item 
% \end{itemize}   
