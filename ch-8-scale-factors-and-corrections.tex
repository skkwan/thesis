...
% https://inspirehep.net/literature/1916962
...
\begin{figure}[h]
    ...
    \end{subfigure}
    \caption[Trigger efficiencies for the muon in the isolated single muon trigger with threshold $p_{T} > 24$ GeV in the data-taking year 2018, as functions of the muon $p_{T}$ (\textit{left}) and muon $|\eta|$ (\textit{right}).]{Trigger efficiencies for the muon in the isolated single muon trigger with threshold $p_{T} > 24$ GeV in the data-taking year 2018, as functions of the muon $p_{T}$ (\textit{left}) and muon $|\eta|$ (\textit{right}). The data is split with respect to a HLT muon reconstruction update deployed on 15/05/2018. Only statistical errors are shown \cite{CMS-DP-2018-034}.} 
\end{figure}
